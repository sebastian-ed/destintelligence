...
-- ============================================================================
-- CONFIGURACIÓN INICIAL DE SANTA FE
-- ============================================================================
-- FLUJO MÁS SIMPLE:
...
declare
  v_admin_email text := null; -- Ej.: 'turismo@santafe.gob.ar' solo si hay varios usuarios.
  v_organization_name text := 'Municipalidad de Santa Fe';
  v_destination_name text := 'Santa Fe';
  v_province text := 'Santa Fe';
